...
bool engine_initialize() {
	if (!aspect::content::load_game()) return false;

	platform::window_init_info info{
		&win_proc, nullptr, L"Aspect Game" //TODO: Get the game name from loaded game file.
	};
