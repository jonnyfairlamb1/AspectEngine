...
public class OpenProject {
    private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\AspectEditor\";
    ...
    static OpenProject() {
        try {
            ...
            Logger.Log(MessageType.Error, $"Failed to open project");
            throw;
        }
    }
    ...
    private static void ReadProjectData() {
        if (File.Exists(_projectDataPath)) {
            ...
            foreach (var project in projects) {
                //check if the project folder was deleted.
                if (File.Exists(project.FullPath)) {
                    project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Aspect\Icon.png");
                    project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Aspect\Screenshot.png");
    ...
    public static Project Open(ProjectData data) {
        ...
        if (project != null) {
            //this is an older project that is already created.
            project.Date = DateTime.Now;
        } else {
            //this is a new project that hasnt been opened yet.
            project = data;
            project.Date = DateTime.Now;
            _projects.Add(project);
        }
