...
public class Project : ViewModelBase {
    public static string Extension { get; } = ".aspect";
    ...
    private static readonly string[] _buildConfigurationsNames = new string[] { "Debug", "DebugEditor", "Release", "ReleaseEditor" };
    ...
    public string[] _availableScripts;
    ...
    private static string GetConfigurationName(BuildConfiguration config) => _buildConfigurationsNames[(int)config];
    ...
    private void AddScene(string sceneName) {
        ...
        _scenes.Add(new(this, sceneName));
    }
    ...
    private void LoadGameCodeDll() {
        ...
        } else Logger.Log(MessageType.Warning, "Failed to load game code DLL file. Try build the project first.");
    }
