...
internal class NewProject : ViewModelBase {
    ...
    private readonly string _templatePath = @"..\..\AspectEditor\ProjectTemplates\";
    ...
    private string _projectPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments)}\AspectProjects\";
    ...
    public NewProject() {
        ...
        try {
            ...
            Logger.Log(MessageType.Error, $"Failed to deserialize {ProjectPath}");
            throw;
        }
    }
    ...
    private bool ValidateProjectPath() {
        ...
        else { ErrorMsg = string.Empty; IsValid = true; }
        return IsValid;
    }
    ...
    public string CreateProject(ProjectTemplate template) {
        ...
        try {
            ...
            var dirInfo = new DirectoryInfo(path + @".Aspect\");
            ...
            Debug.WriteLine(ex.Message);
            Logger.Log(MessageType.Error, $"Failed to create project {template.ProjectType}");
            throw;
        }
    }
    ...
    private void CreateMSVCSolution(ProjectTemplate template, string path) {
        ...
        var engineAPIPath = Path.Combine(MainWindow.AspectPath, @"Engine\EngineAPI\");
        Debug.Assert(Directory.Exists(engineAPIPath));

        var _0 = ProjectName;
        var _1 = "{" + Guid.NewGuid().ToString().ToUpper() + "}";
        var _2 = engineAPIPath;
        var _3 = MainWindow.AspectPath;
